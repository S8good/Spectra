...
class BatchAcquisitionWorker(QObject):
    ...
    def __init__(self, controller: FX2000Controller, layout_data: dict, output_folder: str, file_extension: str,
                 ...
                 operator: str = "", instrument_info: Optional[Dict[str, Any]] = None,
        ...
        config_meta = {key: value for key, value in config_meta.items() if value is not None}
        ...
        if "device_serial" not in base_instrument and controller:
            ...
            base_instrument["device_serial"] = getattr(controller, "serial_number", None)
        ...
        base_processing["parameters"] = {key: value for key, value in parameters.items() if value is not None}
    ...
    def _processing_payload_for_label(self, spectrum_label: str) -> Optional[Dict[str, Any]]:
